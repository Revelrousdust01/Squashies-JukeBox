...
class VLC:
    ...
    def playlist(self,queue):
        response = requests.get('http://localhost:8008/requests/playlist.xml', auth=self.authentication)
    ...
    def add(self, file):
        ...
        response = requests.get('http://localhost:8008/requests/playlist.xml',
    ...
    def status(self):
        response = requests.get('http://localhost:8008/requests/status.xml', auth=self.authentication)
        response = xmltodict.parse(response.text)
        return response
